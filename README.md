...
Deep Learning
* Most examples use [PyTorch](https://pytorch.org/)

Vision
* Vision examples often use [DLib](http://dlib.net) and [OpenCV](https://opencv.org/)


For the edition of code, we will use Visual Code which is light, efficient, configurable and works on Linux, Windows, Mac !  It comes with Anaconda as well. See https://code.visualstudio.com/docs/languages/python

Anaconda or miniconda install python and manage environments
...
Install every packages with 'pip install' 

```
pip install numpy pylint  pillow matplotlib 
pip install jupyter scikit-learn scikit-image
pip install cogsci pygame
pip install opencv
pip install dlib
``` 
...
Also install extensions for `python`.
